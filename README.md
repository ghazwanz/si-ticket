...
|----|--------------|-----|---------------------------------|
| 1 | Ghazwan Ababil | 244107020151 | - **23 Apr 2026**: Refactoring `PesananController` (menggunakan model Order, menghapus data dummy), optimasi `ProfileController` untuk akses tiket QR, dan menghapus *src.zip*. <br> - **20 Apr 2026**: Penambahan model `TicketCategory`, `DemoDataSeeder`, relasi database, fitur form registrasi berbasis *user role*, serta view untuk profil *Admin* dan *Event Organizer*. <br> - **6 Apr 2026**: Refactoring komponen antarmuka ke kustom tema Tailwind dan menetapkan nama aplikasi JoinFest. <br> - **5 Apr 2026**: Implementasi scaffolding autentikasi pengguna dan UI Dashboard. <br> - **18 Mar 2026**: Perancangan dan pembuatan skema *database* untuk *event management*, tiket, *merchandise*, pesanan, dan profil pengguna. <br> - **3-6 Mar 2026**: Inisialisasi awal proyek dan pembaruan struktur folder. |
...
| 3 | Muhammad Fitra Adhim Nurrochman | 244107020089 | - **14 Apr 2026**: Mengintegrasikan *framework* CSS Tailwind dan menambahkan animasi JavaScript pada tampilan *front-end*, serta mengerjakan halaman *Landing Page*, *Login*, *Register*, *Katalog Event*, dan *Detail Event*. <br> - **8 Apr 2026**: Merancang rancangan dasar UI (antarmuka) halaman *Login* dan *Register*, serta melakukan pengujian sinkronisasi *repository*. |
| 4 | Rani Miftahus Sa'adah | 244107020057 | - Merancang UI/UX menggunakan Figma untuk seluruh halaman platform, mencakup pandangan untuk aktor *User*, *Event Organizer*, dan *Admin*. <br> - Berkontribusi dalam penyusunan dan pembuatan dokumentasi/laporan proyek. |
| 5 | Rifo Anggi Barbara Danuarta | 244107020063 | - **14 Apr 2026**: Mengembangkan fitur fungsionalitas pemindai kamera (*camera scanner*) untuk keperluan *check-in* tiket dan *QR code merchandise* yang dilengkapi dengan *feedback* visual. Melakukan peningkatan antarmuka tata letak form *header* & *content section*. Mengembangkan tampilan detail pesanan, *QR Code* tiket aplikasi, serta manajemen profil akun (tampilan *view* beserta rute kontroler aplikasi). |
