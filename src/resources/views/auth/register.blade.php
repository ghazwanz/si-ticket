<x-guest-layout>
    <div class="text-center">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Create an Account</h1>
        <p class="mt-2 text-sm text-slate-500">Sign up to discover and book events.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-5" x-data="{ role: 'user' }">
        ...
        {{-- Role Selection --}}
        <div>
            <label class="mb-2 block text-sm font-medium text-slate-700">I am signing up as a <span class="text-red-500">*</span></label>
        ...
        <div>
            <label for="name" class="mb-2 block text-sm font-medium text-slate-700">Full Name <span class="text-red-500">*</span></label>
            <div class="relative">
        ...
        <div x-show="role === 'organizer'" x-cloak x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-5 rounded-2xl border border-violet-100 bg-violet-50/50 p-5 mt-6">
            <div class="pb-2 border-b border-violet-100">
                ...
                <p class="text-xs text-slate-500 mt-1">Required for verification and ticket payouts.</p>
            </div>

            <div>
                <label for="organization_name" class="mb-2 block text-sm font-medium text-slate-700">Organization Name <span class="text-red-500">*</span></label>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2 sm:col-span-1">
                    <label for="bank_name" class="mb-2 block text-sm font-medium text-slate-700">Bank Name <span class="text-red-500">*</span></label>
                ...
                <div class="col-span-2 sm:col-span-1">
                    <label for="bank_account_number" class="mb-2 block text-sm font-medium text-slate-700">Account Number <span class="text-red-500">*</span></label>
            ...
            <div>
                <label for="bank_account_name" class="mb-2 block text-sm font-medium text-slate-700">Account Holder Name <span class="text-red-500">*</span></label>
