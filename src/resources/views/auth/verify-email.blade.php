<x-guest-layout>
    <div class="text-center">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-3xl">Verify Email</h1>
        <p class="mt-2 text-sm text-slate-505 dark:text-slate-400">Thanks for signing up. Please click the verification link we sent to your email.</p>
    </div>
