...
<div class="max-w-3xl mx-auto">
    <form method="POST" action="{{ route('organizer.merchandise.update', $merchandise->id) }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
        {{-- Informasi Dasar --}}
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
            ...
            <div class="mb-4">
                ...
                <input type="text" value="Kaos Festival Soundwave" required
                       class="w-full rounded-xl border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500">
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                <textarea rows="4" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500">Kaos eksklusif dengan desain minimalis...</textarea>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Gambar Merchandise</label>
                <div class="mb-3 w-full h-48 bg-gray-100 rounded-lg flex items-center justify-center">
                ...
                <div class="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center hover:bg-gray-50 transition-colors cursor-pointer">
                    ...
                    <p class="text-gray-900 font-medium">Ganti gambar</p>
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
            ...
            <div id="variantContainer" class="space-y-6">
                ...
                <div class="border border-gray-100 rounded-xl p-4">
                    <div class="flex justify-between items-center mb-4">
                        <input type="text" value="Ukuran" class="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:ring-purple-500 mr-2">
                        <button type="button" class="text-red-500 hover:text-red-700 font-medium">Hapus Grup</button>
                    </div>
                    <div class="space-y-3 mb-4">
                        @foreach(['S' => 15, 'M' => 20, 'L' => 25, 'XL' => 18] as $size => $stock)
                        <div class="flex gap-3">
                            <input type="text" value="{{ $size }}" class="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:ring-purple-500">
                            <input type="number" value="{{ $stock }}" class="w-24 px-4 py-2 border border-gray-200 rounded-lg focus:ring-purple-500">
                            <input type="number" value="0" class="w-28 px-4 py-2 border border-gray-200 rounded-lg focus:ring-purple-500">
...
<script>
    function addVariantGroup() {
        ...
        newGroup.innerHTML = `
            <div class="flex justify-between items-center mb-4">
                <input type="text" placeholder="Nama Grup Varian" class="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:ring-purple-500 mr-2">
