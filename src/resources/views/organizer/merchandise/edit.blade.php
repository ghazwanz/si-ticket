    ...
    <div class="border-b border-[#E0E0E8] bg-white sticky top-0 z-40">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-[#111118]">Edit Merchandise</h1>
                    <p class="text-[#6B6B80] text-sm mt-1">Kaos Festival Soundwave</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <form class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-[#E0E0E8] p-8">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" value="Kaos Festival Soundwave" 
                           class="w-full px-4 py-3 border border-[#E0E0E8] rounded-lg text-[#111118] focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:border-transparent">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea rows="4"
                              class="w-full px-4 py-3 border border-[#E0E0E8] rounded-lg text-[#111118] focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:border-transparent resize-none">Kaos eksklusif dengan desain minimalis dari Soundwave Festival Jakarta 2026. Terbuat dari bahan cotton premium dengan kualitas premium. Tersedia dalam berbagai ukuran dan warna.</textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <div class="w-full h-48 bg-[#F2F2F7] rounded-lg flex items-center justify-center">
                            <svg class="w-12 h-12 text-[#6B6B80]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="border-2 border-dashed border-[#E0E0E8] rounded-lg p-8 text-center hover:bg-[#F8F8FA] transition-colors cursor-pointer">
                        ...
                        <p class="text-[#111118] font-medium">Ganti gambar</p>
                ...
                <div id="variantContainer" class="space-y-8">
                    ...
                    <div class="border border-[#E0E0E8] rounded-lg p-6">
                        <div class="flex justify-between items-center mb-4">
                            <input type="text" value="Ukuran" 
                                   class="flex-1 px-4 py-2 border border-[#E0E0E8] rounded-lg text-[#111118] focus:outline-none focus:ring-2 focus:ring-[#7C3AED] mr-2">
...
function addVariantGroup() {
    ...
    newGroup.innerHTML = `
        <div class="flex justify-between items-center mb-4">
            <input type="text" placeholder="Nama Grup Varian" 
                   class="flex-1 px-4 py-2 border border-[#E0E0E8] rounded-lg text-[#111118] focus:outline-none focus:ring-2 focus:ring-[#7C3AED] mr-2">
